...
# Questions to ask:
# Unsure of what it means for the train/test data to be taken from uniform grids (10x10 pairs of values for the training
# data, 9x9 pairs for the test data)
...
# these are the sizes of each layer, aka the
# of hidden neurons. we change these numbers to be 2,8,50
size_h1 = tf.constant(625, dtype=tf.int32) 
size_h2 = tf.constant(300, dtype=tf.int32)
# we don't need a 2nd hidden layer (as this would mean we have 3 layers, question only wants 2)
